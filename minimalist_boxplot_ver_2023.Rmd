...
my_plot <- tg_plot + 
  ...
  labs(y = 'Length (mm) \n', x = 'Supplement Type', 
       ...
       subtitle ='Length of guinea pig tooth growth (mm) as a function of vitamin c supplement type (orange juice or ascorbic acid) & dosage (mg/day).' ) + #manually sets axis names & titles
